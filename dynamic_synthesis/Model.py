...
class model_3d():
    ...
    def __init__(self, num_Com_layer):
        ...
        self.Layer_List.append(Conv3D(128, (2, 3, 3), padding='same', name='conv1'))
        self.Layer_List.append(BatchNormalization(name='batch_norm1'))
        self.Layer_List.append(Activation("relu", name='relu1'))

        self.Layer_List.append(Conv3D(128, (2, 3, 3), padding='same', name='conv2'))
        ...
        self.Layer_List.append(Conv3D(64, (2, 3, 3), padding='same', name='conv3'))
        self.Layer_List.append(BatchNormalization(name='batch_norm3'))
        self.Layer_List.append(Activation("relu", name='relu3'))

        self.Layer_List.append(Conv3D(64, (2, 3, 3), padding='same', name='conv4'))
