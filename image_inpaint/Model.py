...
class small_1():    
    def __init__(self):
        ...
        self.Layer_List.append(Conv2D(64, (3, 3), padding='valid', name='conv1'))
        self.Layer_List.append(BatchNormalization(name='batch_norm1'))
        self.Layer_List.append(Activation("relu", name='relu1'))

        self.Layer_List.append(Conv2D(64, (3, 3), padding='valid', name='conv2'))
        ...
        self.Layer_List.append(Conv2D(64, (3, 3), padding='valid', name='conv3'))
